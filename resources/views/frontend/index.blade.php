                ...
                <div class="col-lg-9 offset-lg-3">
                    <div class="main_slider" data-slick='{"arrows": false}'>
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('front/images/slider/slide-2.jpg') }}">
                        ...
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('front/images/slider/slide-3.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                        ...
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('front/images/slider/slide-1.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood
                                    <span>Pressure monitor</span></h4>
                        ...
                        <div class="product-area row">
                            @foreach ($all_products as $product)
                                <div class="col-lg-4 grid">
                                    ...
                                    <div class="details">
                                        <h4><a href="{{ route('product.details', $product->slug) }}">
                                    ...
                                    <div class="category_boxed">
                                        <a href="#!">
                                            <span class="item_image">
                                                <img src="{{ asset('uploads/category') }}/{{ $top_category->category_image }}"
                                                    alt="image_not_found">
                                            </span>
                        ...
                        <div class="widget latest_product_carousel">
                            ...
                            <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{ asset('front/images/latest_product/latest_product_1.png') }}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{ asset('front/images/latest_product/latest_product_2.png') }}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{ asset('front/images/latest_product/latest_product_3.png') }}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{ asset('front/images/latest_product/latest_product_4.png') }}"
                                                alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                ...
                <div class="col col-lg-7">
                    <div class="new-arrivals-grids clearfix">
                        @foreach ($new_arrivals as $new)
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{ '/uploads/product/preview' }}/{{ $new->preview }}" alt>
                                    <div class="actions">
                                        <ul>
                                            <li>
        ...
        <div class="container">
            ...
            <div class="viewed_products_wrap arrows_topright">
                <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                    @foreach ($all_recent_viewed_products as $recent)

                    <div class="slider_item col">
                        <div class="viewed_product_item">
                            <div class="item_image">
                                <img src="{{ asset('uploads/product/preview') }}/{{ $recent->preview }}"
                                    alt="image_not_found">
                            </div>
                            <div class="item_content">
