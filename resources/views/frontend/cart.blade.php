                    ...
                    <tbody>
                        ...
                        @foreach ($carts as $cart)
                            <tr>
                                ...
                                <td class="text-center abc"><span
                                        class="price_text">{{ $cart->rel_to_product->after_discount }}</span></td>
                                ...
                                <td class="text-center abc"><span
                                        class="price_text">{{ $cart->rel_to_product->after_discount * $cart->quantity }}</span>
                                </td>
                                <td class="text-center"><a href="{{ route('cart.remove', $cart->id) }}"
