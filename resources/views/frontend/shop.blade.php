                    ...
                    <aside class="sidebar_section p-0 mt-0">
                        <div class="sb_widget">
                            ...
                            <div class="filter_sidebar">
                                            ...
                                            @foreach ($categories as $category)
                                                <li>
                                                    <div class="checkbox_item">
                                                        <input id="apple_brand" type="radio" class="category_id"
                                                            name="brand_checkbox" / value="{{ $category->id }}"
                                    ...
                                    <form action="#">
                                        <ul class="fs_brand_list ul_li_block">
                                            @foreach ($colors as $color)
                                                <li>
                                                    <div class="checkbox_item">
                                                        <input id="apple_brand" type="radio" class="color_id"
                                                            name="brand_checkbox"  value="{{ $color->id }}"
                                    ...
                                    <form action="#">
                                        <ul class="fs_brand_list ul_li_block">
                                            @foreach ($sizes as $size)
                                                <li>
                                                    <div class="checkbox_item">
                                                        <input id="apple_brand" type="radio" class="size_id"
                                                            name="brand_checkbox"  value="{{ $size->id }}"
                                ...
                                <div class="mb-3">
                                    <input type="text" id="min" value="{{ @$_GET['min'] }}" placeholder="Min" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <input type="text" id="max" value="{{ @$_GET['max'] }}" placeholder="Max" class="form-control">
                                </div>
                                <button type="submit" id="amount" class="btn btn-primary">Submit</button>
                            </div>
                        </div>
                    </aside>
                </div>
                            ...
                            <div class="col col-md-4">
                                <form action="#">
                                    <div class="select_option clearfix">
                                        <select class="nice-select menuselect">
                                        ...
                                        <div class="grid">
                                            <div class="product-pic">
                                                <img src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}"
                                                    alt />
                                                @if ($product->discount)
                                                    <span class="theme-badge">{{ $product->discount }} %off</span>
                                                @endif
                                            </div>
                                            <div class="details">
                                                ...
                                                <span class="price">
                                                    <ins>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi> <span class="woocommerce-Price-currencySymbol">BDT:
    ...
    <script>
        $('#search_btn').click(function() {
            ...
            var link = "{{ route('shop') }}?" + "q=" + search_input + "&category_id=" + category_id +
                "&color_id=" + color_id + "&size_id=" + size_id+"&min="+min+"&max="+max;
