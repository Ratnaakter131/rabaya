                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                                <div class="advance_serach">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <button type="submit" id="search_btn" class="search_btn"><i
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="allcategories_collapse  {{ Route::currentRouteName() == 'index' ? '' : 'collapse' }}"
                ...
                <div class="cart_sidebar">
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        ...
                        @forelse (App\Models\Cart::where('customer_id', Auth::guard('customerlogin')->id())->get() as $cart)
                            ...
                            @empty
                              <li>
                               <div class="alert alert-primary"> <h5>You have not added any product yet !!!</h5></div>
                            </li>
                        @endforelse
                    </ul>
