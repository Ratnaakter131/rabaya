                    ...
                    <div class="register_wrap tab-content">
                        <div class="tab-pane fade show active" id="signin_tab" role="tabpanel">
                            <form action="{{ route('customer.login') }}" method="POST">
                                ...
                                <div class="form_item_wrap">
                                    <button type="submit" class="btn btn_primary">Sign In   </button>  <a href="{{ route('customer.pass.reset.req') }}">Forgot your password</a>
                                </div>

                                <div class="form_item_wrap mt-4 ">
                                    <a href="{{ route('github.redirect') }}" class="btn  btn_primary">Sign In With  <i class="fab fa-github"></i>  </a>
                                    <a href="{{ route('google.redirect') }}" class="btn  btn_primary">Sign In With  <i class="fab fa-google"></i> </a>
