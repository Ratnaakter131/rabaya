                                    ...
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p class="form-row form-row form-row-first address-field update_totals_on_change validate-required"
                                            ...
                                            <label for="billing_country" class="">Country <abbr
                                                    class="required" title="required">*</abbr></label>
                                            <select name="country_id" id="country_id" autocomplete="country"
                                        ...
                                        <p class="form-row form-row form-row-last address-field update_totals_on_change validate-required"
                                            ...
                                            <label for="billing_country" class="">City <abbr
                                                    class="required" title="required">*</abbr></label>
                                            <select name="city_id" id="city_id" autocomplete="country"
                                                class="country_to_state country_select ">
                                ...
                                <table class="shop_table woocommerce-checkout-review-order-table">
                                    ...
                                    <tr class="cart-subtotal">
                                        ...
                                        <td><span class="woocommerce-Price-amount amount"></span>
                                            {{ session('discount') }} {{(session('type') == 1?'%':'BDT')}}</span>
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td><strong>BDT: <span class="woocommerce-Price-amount amount total"> {{ (session('type') == 1?$sub_total - ($sub_total*session('discount'))/100:$sub_total-session('discount')) }}</span></strong>
                                        </td>
                                    </tr>
                                </table>
